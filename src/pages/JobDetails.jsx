  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-10">
      ...
      <Container maxWidth="xl" sx={{ mt: 4 }}>
        ...
        {tabValue === 1 && (
            <Box>
                ...
                <Grid container spacing={3}>
                    ...
                    {/* GRÁFICO 2: RADAR (Comparativo Média vs Ideal) */}
                    <Grid item xs={12} md={5}>
                        <Paper sx={{ p: 3, height: 450, borderRadius: 2, boxShadow: 2 }}>
                            <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                                <Typography variant="h6" fontWeight="bold">Comparativo de Perfil</Typography>
                                <Chip label="Ideal vs Média" size="small" color="default" />
                            </Box>
                            <Typography variant="caption" color="text.secondary" display="block" mb={2}>
                                Linha pontilhada preta: Perfil Ideal (Meta)
                                <br/>Área Azul: Média dos candidatos reais
                            </Typography>
                            ...
                            <ResponsiveContainer width="100%" height="85%">
                                <RadarChart cx="50%" cy="50%" outerRadius="70%" data={radarData}>
                                    ...
                                    {/* Média dos Candidatos (Área Azul) */}
                                    <Radar 
                                    ...
                                    {/* Perfil Ideal (Linha Preta Pontilhada) */}
                                    <Radar 
                                        name="Perfil Ideal" 
                                        dataKey="Ideal" 
                                        stroke="#000000" 
        ...
        {/* TAB 2: CONFIGURAÇÃO DE PARÂMETROS */}
        {tabValue === 2 && parameters && (
            <Paper sx={{ p: 4, borderRadius: 2, boxShadow: 1 }}>
                <Box display="flex" justifyContent="space-between" mb={3}>
                    <Typography variant="h6" fontWeight="bold">Critérios e Pesos da Vaga</Typography>
                    <Button startIcon={<Copy size={16}/>} variant="outlined" onClick={() => setIsCopyModalOpen(true)}>
                        Copiar Modelo
                    </Button>
                </Box>
                ...
                <Grid container spacing={5}>
                    <Grid item xs={12} md={6}>
                        <Typography fontWeight="bold" color="primary" gutterBottom>1. Triagem (Requisitos)</Typography>
                        <ParametersSection criteria={parameters.triagem} onCriteriaChange={v => setParameters({ ...parameters, triagem: v })} />
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <Typography fontWeight="bold" color="primary" gutterBottom>2. Fit Cultural</Typography>
                        <ParametersSection criteria={parameters.cultura} onCriteriaChange={v => setParameters({ ...parameters, cultura: v })} />
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <Typography fontWeight="bold" color="primary" gutterBottom>3. Teste Técnico</Typography>
                        <ParametersSection criteria={parameters.tecnico} onCriteriaChange={v => setParameters({ ...parameters, tecnico: v })} />
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <Typography fontWeight="bold" color="secondary" gutterBottom>4. Escala de Notas</Typography>
                        <RatingScaleSection scale={parameters.notas} onScaleChange={v => setParameters({ ...parameters, notas: v })} />
                    </Grid>
                </Grid>
      ...
      <CopyParametersModal open={isCopyModalOpen} onClose={() => setIsCopyModalOpen(false)} onSelect={(p) => { setParameters(p); setSnackbar({ open: true, message: 'Parâmetros copiados!' }) }} />
    </div>
  );
}
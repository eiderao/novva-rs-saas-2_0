...
export default function ApplicationDetails() {
          ...
          if (user) {
              ...
              if (myEval) {
                  setCurrentUserEvaluation({
                      ...
                      final_score: myEval.final_score // Minha nota salva
                  });
              } else {
  ...
  // Badge Compacto com Nota Global e Minha Nota
  ...
  return (
    <Box sx={{ bgcolor: '#f8f9fa', minHeight: '100vh', p: 2 }}>
      ...
      <Grid container spacing={2}>
        {/* LADO ESQUERDO: INFO CANDIDATO (30%) */}

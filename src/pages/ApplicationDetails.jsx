      ...
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden mb-6">
        <div className="p-8 border-b bg-gradient-to-r from-gray-50 to-white flex justify-between items-start">
            <div className="flex gap-6">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">{app.candidate?.name || 'Candidato Desconhecido'}</h1>
                    <div className="flex items-center gap-2 mt-1 text-gray-600">
                        <Briefcase size={16} />
                        <span className="font-medium">{app.job?.title || 'Vaga não identificada'}</span>
                    </div>
